...
public class SlidView extends LinearLayout {
 ...
 // 用来放置所有view的容器
    ...
    */
    ...
    public String getButtonText(){
       return ((TextView) findViewById(R.id.delete)).getText().toString();
    }
 ...
 // 设置按钮的内容，也可以设置图标啥的，我没写
  ...
  public void onRequireTouchEvent(MotionEvent event) {
      ...
      case MotionEvent.ACTION_MOVE: {
          ...
          Log.i(LOGCAT, "x=" + x + " y=" + y+" deltaX="+deltaX+" deltaY="+deltaY+" scrollX="+scrollX+" newScrollX"+newScrollX);
